      ...
      <div className="row">
        <div className="col-lg-4 col-md-6 col-sm-4">
          <Link to="/app/binallotmentdetails">
            <div
              className="card bg-base-100 shadow-xl mb-4 p-3"
              // style={{ width: "14rem" }}
            >
              <div className="">
        ...
        <div className="col-lg-4 col-md-6 col-sm-4">
          <Link to="">
            ...
            /> */}
                  ...
                  />
                  <h4 className="text-xl font-semibold">Bin Retrieval</h4>
                </div>
              </div>
            </div>
          </Link>
        </div>
        <h1 class="text-2xl font-medium">Fixed Asset(FA)</h1>
        <div className="col-lg-4 col-md-6 col-sm-4">
        ...
        <h1 class="text-2xl font-medium">Reports</h1>
        <div className="col-lg-4 col-md-6 col-sm-4">
          <Link to="/app/reports">
            <div
              className="card bg-base-100 shadow-xl mb-4 p-3 mt-3"
