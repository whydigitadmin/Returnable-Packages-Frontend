...
function DocumentCreation({ addEmitter, emitterEditId }) {
  ...
  const [role, setRole] = React.useState("ROLE_DOCUMENT");
  ...
  const handleEmitterCreationClose = () => {
    if (firstName || phone || address || city || state || country || pincode) {
