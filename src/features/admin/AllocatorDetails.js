...
import AllocatorCreation from "./AllocatorCreation";

export const AllocatorDetails = () => {
  ...
  return (
    <>
      {(addUser && <AllocatorCreation addUser={handleBack} />) ||
        (editUser && (
          <AllocatorCreation addUser={handleBack} userEditId={selectedRowId} />
        )) || (
