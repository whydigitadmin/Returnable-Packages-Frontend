...
function ReloctionConfig({ open }) {
  const handleCloseReloctionConfig = () => {
    open(false);
  };
  return (
    <>
      <Dialog
        ...
        maxWidth={"sm"}
        open={open}
        onClose={handleCloseReloctionConfig}
      >
        <div className="d-flex justify-content-between">
          <DialogTitle>RTI Relocation Form Config</DialogTitle>
          <IoMdClose
            onClick={handleCloseReloctionConfig}
        ...
        <DialogActions className="mb-2 me-2">
          <Button>Reset</Button>
          <Button onClick={handleCloseReloctionConfig}>Cancel</Button>
...
export default ReloctionConfig;
