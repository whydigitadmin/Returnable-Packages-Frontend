...
function ReturnConfig({ open }) {
  const handleCloseReturnConfig = () => {
    open(false);
  };
  return (
    <>
      <Dialog
        ...
        maxWidth={"sm"}
        open={open}
        onClose={handleCloseReturnConfig}
      >
        <div className="d-flex justify-content-between">
          <DialogTitle>RTI Return Form Config</DialogTitle>
          <IoMdClose
            onClick={handleCloseReturnConfig}
        ...
        <DialogActions className="mb-2 me-2">
          <Button>Reset</Button>
          <Button onClick={handleCloseReturnConfig}>Cancel</Button>
