...
function AddAllotment({ addAllotment }) {
    ...
    <>
      <div className="card w-full p-6 bg-base-100 shadow-xl">
        <h1 className="text-xl font-semibold mb-4 ms-5">
          New Delivery Challan-Allotment
        </h1>
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6">
            <ToolTip
              placeholder={"Enter"}
              content={
                "Recipient of products or services in your supply chain."
              }
          ...
          <div className="col-lg-6 col-md-6 my-4 border rounded py-2">
            <div className="d-flex justify-content-between">
              <div>
                ...
                <label className="label fw-bold label-text label-font-size text-base-content">
                  Total Weight
                </label>
                <span className=" label fw-normal label-text label-font-size text-base-content">
