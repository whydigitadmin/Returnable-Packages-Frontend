...
const statsData = [
  {
    title: "Allotment",
    value: "0",
    icon: <FaTruckLoading className="w-5 h-5 text-white dashicon-sm" />,
    description: "",
  },
  {
    title: "Outward",
  ...
  },
  {
    title: "Balance",
    value: "0",
    icon: <FaBalanceScale className="w-5 h-5 text-white dashicon-sm" />,
    description: "",
  },
  {
    title: "Ageing",
...
const columns = [
  ...
  { field: "TransactionNo", headerName: "Transaction No", width: 180 },
  ...
  return (
    <>
      <div className="card w-full p-6 bg-base-100 shadow-xl">
        ...
        <div className="">
          <h1 className="text-2xl font-semibold mt-4">Outward</h1>
