...
export const CompanyDetails = () => {
  ...
  return (
    <>
      {(newCompany && <NewCompany newCompany={handleBack} />) ||
        (editCompany && (
          <NewCompany newCompany={handleBack} companyEditId={selectedRowId} />
        )) || (
