...
import AddChargeTypeRequest from "./AddChargeTypeRequest";

function ChargeTypeRequest() {
  ...
  return (
    <>
      {(addItem && <AddChargeTypeRequest addItem={handleBack} />) ||
        (editKit && (
          <AddChargeTypeRequest
            addItem={handleBack}
            kitEditId={selectedRowId}
          />
        )) || (
