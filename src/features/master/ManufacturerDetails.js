...
function ManufacturerDetails({ addcustomer }) {
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 mt-1">
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 mt-1">
                <ToolTip
                  placeholder={"Manufacturing Product"}
                  content={"Manufacturing Product"}
                  updateFormValue={updateFormValue}
                />
              </div>
              <div className="col-lg-11 col-md-11 col-sm-11 border-dotted border-2 border-black-600 text-center rounded m-4">
                <button
                  type="button"
