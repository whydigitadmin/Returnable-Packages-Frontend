      ...
      >
        <div className="d-flex flex-row m-3">
          <button
            ...
            aria-label="Close"
          >
            <MdArrowForwardIos className="w-7 h-7 mb-1" />
          </button>
          <h5 className="text-2xl font-semibold" id="offcanvasRightLabel">
            Create New Issue
          </h5>
        </div>
        <div className="offcanvas-body">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 mb-2"></div>
            <div className="col-lg-4 col-md-6 mb-2">
              <label className="label">
                <span
                  className={
          ...
          <div className="col-lg-2 col-md-4 mb-2">
            <button className="btn bg-base-100 btn-outline">VALIDATE</button>
          </div>
        </div>
      </div>
    </>
